...
public interface ItineraryService {
    ...
    ItineraryDay updateVisitOrder(Long itineraryId, Long dayId, UpdateVisitOrderDTO dto);
    void setPlaceVisited(Long itineraryId, Long dayId, Long placeId);
    ItineraryPlace updatePlace(Long itineraryId, Long dayId, Long placeId, UpdatePlaceDTO dto);
